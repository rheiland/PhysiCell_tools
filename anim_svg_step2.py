#
# anim_svg_step2.py:  render/animate PhysiCell .svg files, using left/right arrows on keyboard
#
# Usage:
#  python anim_svg_step.py <show_nucleus start_index svg_xmin svg_xmax svg_ymin svg_ymax xmin xmax ymin ymax scale_radius>
...
print("svg_xmin,svg_xmax=",svg_xmin,svg_xmax)
print("svg_ymin,svg_ymax=",svg_ymin,svg_ymax)
